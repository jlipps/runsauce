...
var fixAppium1Caps = function(opts, caps, onSauce) {
  caps['appium-version'] = opts.backendVersion.toString();
  var tt = opts.testType.toLowerCase();
  var natives = ["appium", "ios", "android", "android_long", "selendroid",
                 "android_hybrid"];
  if (_.contains(natives, tt)) {
    caps.browserName = '';
  }
...
var fixAppiumCaps = function(opts, caps, onSauce) {
  ...
  console.log("Appiumver is " + appiumVer);
  if (appiumVer >= 1) {
