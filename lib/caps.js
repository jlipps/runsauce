...
const NATIVE_TESTS = [
  "appium", "ios", "android", "android_long", "selendroid", "android_hybrid",
...
function fixCaps (testSpec, caps) {
  ...
  if (caps.device || _.contains(NATIVE_TESTS, testSpec.test)) {
...
function fixAppiumCaps (testSpec, caps) {
  ...
  if (_.contains(WEB_TESTS, tt) && caps.platformName === "iOS") {
