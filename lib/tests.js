...
tests.iosTest = o_O(function*(driver, caps) {
  console.log(" - Running basic appium iOS test");
  caps.name = "Basic appium iOS test";
  yield start(driver, caps);
...
tests.androidTest = o_O(function*(driver, caps) {
  console.log(" - Running basic appium android test");
  caps.name = "Basic appium android test";
  yield start(driver, caps);
...
tests.selendroidTest = o_O(function*(driver, caps) {
  console.log(" - Running basic appium selendroid test");
  caps.name = "Basic appium selendroid test";
  yield start(driver, caps);
